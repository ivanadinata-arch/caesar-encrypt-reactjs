...
export default function App() {
  ...
  return (
    <div className='bg-slate-800 w-full h-screen text-white'>
      <h1 className='text-center font-bold text-3xl py-4'>Caesar Cipher with JavaScript</h1>
      <div className='flex flex-row justify-items-center mt-12'>
        <div className='flex-1 mx-8'>
          ...
          <div className='mt-4'>
            ...
            <input ref={keyPlainText} type='number' max={26} min={2} placeholder='Input you Key ....' className='w-full mt-2 p-2 border text-slate-900 border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500' />
          </div>
          <div className='mt-4'>
        ...
        <div className='flex-1 mx-8'>
          ...
          <div className='mt-4'>
            <label className='block text-sm font-medium'>Key (1 - 26)</label>
            <input ref={keyCiphertext} type='number' max={26} min={2} placeholder='Input you Key ....' className='w-full mt-2 p-2 border text-slate-900 border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500' />
          </div>
          <div className='mt-4'>
